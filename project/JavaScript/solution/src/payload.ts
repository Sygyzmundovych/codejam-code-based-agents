 ...
 * Contains art items with some missing values marked with '[PREDICT]'
 * for the RPT-1 model to predict
 */
export const payload: RPT1Payload = {
    ...
    data_schema: {
        ...
        ITEM_CATEGORY: {
            dtype: 'string',
            categories: ['Painting', 'Sculpture', 'Jewelry'],
        },
        DIMENSIONS: { dtype: 'string' },
        CONDITION_SCORE: {
            dtype: 'numeric',
            range: [1, 10],
            description: '1=Poor to 10=Pristine',
        },
        RARITY_SCORE: {
            dtype: 'numeric',
            range: [1, 10],
            description: '1=Common to 10=Extremely Rare',
        },
        PROVENANCE_CLARITY: {
            dtype: 'numeric',
            range: [1, 10],
            description: '1=Unknown to 10=Perfect Documentation',
        },
    },
}
